...
if args.game == "reachability":
    arena1 = load_arena("assets/random_arenas/ran_arena_10_10_10.txt")
    arena2 = load_arena("assets/random_arenas/ran_arena_100_100_10.txt")
    arena3 = load_arena("assets/random_arenas/ran_arena_1000_1000_10.txt")
    arena4 = load_arena("assets/random_arenas/ran_arena_10000_10000_10.txt")
    arena5 = load_arena("assets/random_arenas/ran_arena_100000_100000_10.txt")
    ...
    start = time.time()
    win0, strat0, win1, strat1 = reachability_solver(arena4, R)
    times.append(time.time() - start)
    print("Arena4 done")

    start = time.time()
    win0, strat0, win1, strat1 = reachability_solver(arena5, R)
    times.append(time.time() - start)
    print("Arena5 done")
...
# Safety Solver
    ...
    start = time.time()
    win0, strat0, win1, strat1 = safety_solver(arena4, S)
    times.append(time.time() - start)
    print("Arena4 done")

    start = time.time()
    win0, strat0, win1, strat1 = safety_solver(arena5, S)
    times.append(time.time() - start)
    print("Arena5 done")
...
# Buchi solver
    ...
    start = time.time()
    win0, strat0, win1, strat1 = buchi_solver(arena4, F)
    times.append(time.time() - start)
    print("Arena4 done")

    start = time.time()
    win0, strat0, win1, strat1 = buchi_solver(arena5, F)
    times.append(time.time() - start)
    print("Arena5 done")
...
# Co-buchi solver
    ...
    start = time.time()
    win0, strat0, win1, strat1 = cobuchi_solver(arena4, C)
    times.append(time.time() - start)
    print("Arena4 done")

    start = time.time()
    win0, strat0, win1, strat1 = cobuchi_solver(arena5, C)
    times.append(time.time() - start)
    print("Arena5 done")
...
# Parity solver
    ...
    arena1 = load_arena_parity("assets/random_arenas/ran_arena_10_10_10.txt")
    arena2 = load_arena_parity("assets/random_arenas/ran_arena_100_100_10.txt")
    arena3 = load_arena_parity("assets/random_arenas/ran_arena_1000_1000_10.txt")
    arena4 = load_arena_parity("assets/random_arenas/ran_arena_10000_10000_10.txt")
    arena5 = load_arena_parity("assets/random_arenas/ran_arena_100000_100000_10.txt")
    ...
    start = time.time()
    win0, win1, strat0, strat1 = parity_solver_strategy(arena4)
    times.append(time.time() - start)
    print("Arena4 done")

    start = time.time()
    win0, win1, strat0, strat1 = parity_solver_strategy(arena5)
    times.append(time.time() - start)
    print("Arena5 done")
